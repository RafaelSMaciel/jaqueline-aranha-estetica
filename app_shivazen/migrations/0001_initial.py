# Generated by Django 5.2.1 on 2026-03-20 12:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ativo', models.BooleanField(default=True)),
                ('data_cadastro', models.DateTimeField(auto_now_add=True)),
                ('categoria', models.ForeignKey(blank=True, db_column='id_categoria', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='produtos', to='app_shivazen.categoriaproduto')),
            ],
            options={
                'db_table': 'produto',
                'ordering': ['nome'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(blank=True, db_column='id_usuario', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('produto', models.ForeignKey(db_column='id_produto', on_delete=django.db.models.deletion.CASCADE, related_name='movimentacoes', to='app_shivazen.produto')),
            ],
            options={
